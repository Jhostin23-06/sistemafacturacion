      ...
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">FACTURACIÓN
              ...
              <button type="button" class="btn btn-primary btn-sm" title='Grabar' data-toggle="modal" data-target="#forma-pago"  style='font-size:12px;color:#0080FF;background-color:#FFFF00;border:none'><span class='glyphicon glyphicon-floppy-save'></span></button>
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                  <div class="form-row"  >
                      ...
                      <div class="form-group col-md-3">
                          <label style='color:#0080FF' for="f_cedula">Cliente:</label>
                          <input style='color:#0080FF' type="text" class="form-control" id="Cedula" name='Cedula' placeholder="Cédula o RUC" >
                      </div>
                      <div class="form-group col-md-1">
                          <label style='color:#FFFFFF' for="f_buscar">Bus</label>
                          <button style='color:#0080FF' class='btn btn-primary btn-md' title='' onClick="popup('cliente')" type='button'> <span class='glyphicon glyphicon-search' ></span> </button>
                      </div>
                      <div class="form-group col-md-5">
                          <label style='color:#0080FF'  for="f_apellidos">Nombre Cliente:</label>
                          <input style='color:#0080FF' type="text" class="form-control" id="NombreCliente" name='NombreCliente' readonly="yes">
                      </div>
                      <div class="form-group col-md-3">
                              <label style='color:#0080FF'  for="f_apellidos">Teléfono: </label>
                              <input style='color:#0080FF' type="text" class="form-control" id="Telefono" name='Telefono' readonly="yes">
                      </div>    
                 </div>            
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        <label style='color:#0080FF'  for="f_colegio">Colegio:</label>
                        <select style='color:#0080FF' id='IdColegio' name='IdColegio' class="form-control" onchange='getPorceDescuento()'>
                      ...
                      <div class="form-group col-md-4">
                              ...
                              <input style='color:#0080FF;text-align:right;' type="number" class="form-control" id="Descuento" name='Descuento' readonly="yes" value='0.00' step='0.01'>
                      </div>                         
                  </div>
