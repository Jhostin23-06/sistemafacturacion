  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data' >  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">NOTAS DE VENTA
              <?php echo "<button class='btn btn-primary btn-sm' title='Regresar' style='font-size:12px;color:#0080FF;background-color:    #FFFF00;border:none' onClick='window.location=\"../inicio/menu.php\"' type='button'> <span class='glyphicon glyphicon-backward'></span> </button>";include('modalFormaPagoNV.php');?>
                ...
                <div class="form-row"  style='width:100%;padding:2px;margin: 7px;margin-top: 0px;margin-right: 0px'>
                 ...
                 <!--     <div class="form-group col-md-4" style='padding: 4px;margin: 0px;'>
                  ...
                  <div class="form-group col-md-2" style='padding:0px;margin: 7px;margin-top: 0px'>
                          ...
                          <input  type="text" class="form-control" id="Codigo" name='Codigo' placeholder="Código Barra" required="yes" onkeydown="capturaKeyNV(event);">
                  </div>
                  ...
                  <div class="form-group col-md-2" style='padding:0px;margin: 7px;margin-top: 0px'>
                      ...
                      <input style='color:#0080FF' type="number" class="form-control" id="Precio" name='Precio' >
                  </div> 

                  <div class="form-group col-md-1" style='padding:0px;margin: 7px;margin-top: 0px'>
                    <label style='color:#FFFFFF' for="f_add">adiccio</label>
                    <input type='button' name='btnAgregar' id='add' class='btn btn-primary btn-sm' value='Add' onclick="addFilasNV();" >
                  </div>
               </div>
...
$(document).ready(function(){
  ...
  $("#NombreProducto").keyup(function(){ 
      ...
      if(busquedaProducto.length>1)
      {
        ...
        $.ajax({
          url: 'retornaDatosProductoNVAjax.php',
          method:  'POST',
          contentType: 'application/x-www-form-urlencoded',
