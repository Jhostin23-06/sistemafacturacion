...
<body onload='foco()'>
<section>
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data' action='GrabarSubCategoria.php'>  
      <div class='container'>
        <div class='panel panel-default'>
            <?php echo"<div class='panel-heading' style='font-size: 20px;color:#0080FF;font-weight:bold;'>Nuevo Sub Categoría
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input style='color:#0080FF' type="text" class="form-control" id="nombresubcategoria" name="nombresubcategoria" placeholder="Nombre Sub Categoría" onblur='return VerificarDatos()'>
                  </div>
                  <div class="form-group col-md-6">
