     ...
     <div class='container'>
         <div class='panel panel-default'>
            ...
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">Facturas Proveedores    <?php echo "<button class='btn btn-primary btn-sm' title='Regresar' style='font-size:12px;color:#0080FF;background-color:    #FFFF00;border:none' onClick='window.location=\"../inicio/menu.php\"' type='button'> <span class='glyphicon glyphicon-backward'></span> </button>";
             ...
             ?>
              <button  class="btn btn-primary btn-sm" title='Grabar' id='btn_grabar_fact' onClick='trampa(event);' style='font-size:12px;color:#0080FF;background-color:#FFFF00;border:none'><span class='glyphicon glyphicon-floppy-save'></span></button>
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;padding: 0px;"> 
                  ...
                  <div class="form-row" style="padding: 4px;margin: 0px;" >
                      ...
                      <div class="form-group col-md-3" style='padding: 4px;margin: 0px;'>
                          <label style='color:#0080FF;padding: 2px;margin: 0px;' for="proveedor">RUC Proveedor:</label>
                          <input style='color:#0080FF;padding: 2px;margin: 0px;' type="text" onkeypress="buscarProveedorRuc(event);return pulsar(event);"  class="form-control" id="RucProveedor" name='RucProveedor' placeholder="Cédula o RUC" required="yes">
                      </div>

                      <div class="form-group col-md-6" style='padding: 4px;margin: 0px;'>
                          <label style='color:#0080FF;padding: 2px;margin: 0px;' for="f_apellidos">Nombre Proveedor:</label>
                          <input style='color:#0080FF;padding: 2px;margin: 0px;' class="form-control" id="NombreProveedor" name='NombreProveedor' onkeypress='return pulsar(event);'  >
                          <div id="sugerencias" class='list-group'>
                          </div>
                      </div>
                      <div class="form-group col-md-3"  style='padding: 4px;margin: 0px;'>
                              <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_apellidos">Fecha Factura: </label>
                              <input style='color:#0080FF;padding: 2px;margin: 0px;' type="date" onkeypress="return pulsar(event)" class="form-control" id="FecFactura" name='FecFactura' required="yes">
                      </div>    
                 </div>            

                  <div class="form-row" style="padding: 4px;margin: 0px;" >
                      <div class="form-group col-md-2"  style='padding: 4px;margin: 0px;'>
                              <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_descuento">Descuento: </label>
                              <input style='color:#0080FF;padding: 2px;margin: 0px;text-align:right;' type="number" class="form-control" id="Descuento" name='Descuento' value='0.00' step='0.01' onkeypress="return pulsar(event)">
                      </div>                       
                      <div class="form-group col-md-3"  style='padding: 4px;margin: 0px;'>
                              <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_descuento">No Factura: </label>
                              <input style='color:#0080FF;padding: 2px;margin: 0px;text-align:right;' type="text" class="form-control" id="FacturaSri" name='FacturaSri' required="yes" onkeypress="return pulsar(event)">
                      </div>       
                      <div class="form-group col-md-3"  style='padding: 4px;margin: 0px;'>
                        <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_apellidos">Estado Fact:</label>
                        <select style='color:#0080FF;padding: 2px;margin: 0px;'  id='IdEstadoFinanciero' name='IdEstadoFinanciero' class="form-control"  required="yes" onkeypress="return pulsar(event)">
                      ...
                      <div class="form-group col-md-4"  style='padding: 4px;margin: 0px;'>
                        <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_apellidos">Forma Pago:</label>
                        <select style='color:#0080FF;padding: 2px;margin: 0px;' id='IdFormaPagoProveedor' name='IdFormaPagoProveedor' class="form-control" required="yes" onkeypress="return pulsar(event)">
                            <option value=''>Seleecionar</option>
                            <?php
                 ...
                 <!-----DATOS DE PROVEEDOR --->
                  <div class="form-row" style="padding: 4px;margin: 0px;" >
                      ...
                      <div class="form-group col-md-3" style='padding: 4px;margin: 0px;'>
                        <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_apellidos">Banco:</label>
                        <select style='color:#0080FF;padding: 2px;margin: 0px;' id='IdBanco' name='IdBanco' class="form-control" required="yes" onkeypress="return pulsar(event)">
                            <option value=''>Seleecionar</option>
                            <?php
                               echo $ListaBancos;
                             ?>
                      ...
                      <div class="form-group col-md-3" style='padding: 4px;margin: 0px;'>
                              <label style='color:#0080FF;padding: 2px;margin: 0px;'  for="f_descuento">Referencia: </label>
                              <input style='color:#0080FF;padding: 2px;margin: 0px;text-align:right;' type="text" class="form-control" id="Referencia" name='Referencia' required="yes" onkeypress="return pulsar(event)">
                      </div> 
...
function buscarProveedorRuc(e) { 
  var longproveedor= $('#RucProveedor').val().length;
  var xflag ;
  tecla = (document.getElementById('RucProveedor')) ? e.keyCode :e.which; 
  if(tecla==13 )
  {
         pulsar(e);
         if(longproveedor==10 || longproveedor==13 )
         {
              ...
              xhr.onreadystatechange= retornaDatosProveedor;
              xhr.open('POST','retornaDatosProveedor.php',false);
              xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
              xhr.send("ruc="+$('#RucProveedor').val());
              function retornaDatosProveedor()
              {
               if(xhr.readyState==4)
                  {
                    if(xhr.status==200)
                      {
                        ...
                        if(DatosString ==0)
                        {
                            alert('RUC de proveedor no existe, debe ingresarlo en el programa de ingreso de proveedores');
                            document.getElementById('RucProveedor').focus();
                        }
                        else
                        {
                            var opciones;
                            datosArray  =  DatosString.split('_;_');    
                            $('#IdProveedor').val(datosArray[0]);
                            $('#RucProveedor').val(datosArray[1]);
                            $('#NombreProveedor').val(datosArray[2]);
                        }
                      }
                  }
               }
...
$(document).ready(function(){
  $("#NombreProveedor").keyup(function(){
      ...
      {
        $.ajax({
          url: 'retornaDatosProveedor2.php',
          method:  'POST',
