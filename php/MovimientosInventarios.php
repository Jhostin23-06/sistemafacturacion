  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">MOVIMIENTOS DE INVENTARIOS
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoMovimientoInv.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th width="10%" bgcolor='#FFBF00' style='color: #0080FF'><b><center>Codigo <br> Movimiento</center></b></th>
                    <th width="50%" bgcolor='#FFBF00' style='color: #0080FF'><b><center>Descripción Movimiento</center></b></th>
                    <th width="25%" bgcolor='#FFBF00' style='color: #0080FF'><b><center>Naturaleza</center></b></th>
                    <th width="15%" bgcolor='#FFBF00' style='color: #0080FF'><b><center>Estado</center></b></th>
                </tr>
            </thead>
            <tbody class='scrollContent'  >
                <?php 
                    $contador=0;
                    $StrSql="SELECT * FROM traslados ";     
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      switch ($registro['Signo']) {
                        case '+1':
                          $DescripcionTraslado= "INGRESO MERCADERIA";
                          break;
                        case '-1':  
                          $DescripcionTraslado= "EGRESO DE MERCADERIA";
                          break;
                      }
                      echo  
                      "<tr style='color: #0080FF'>
                        <td><center>".$registro['IdCodigoTraslado']."</center></td>   
                        <td>".utf8_encode($registro['DescripcionTraslado'])."</td>                   
                        <td>".$DescripcionTraslado."</td>
                    ...
                    if($contador==0)
                    {
                        echo "<h2>No existen Movimientos</h2>";   
                    }?>
                </tbody>               
            </table>
              </div>
