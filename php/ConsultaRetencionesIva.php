  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE IMPUESTOS
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoImpuesto.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Porcentaje</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>%Retener</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Codigo SRI</center></b></th>                    
            ...
            <tbody class='scrollContent'  >
                <?php 
                    $contador=0;
                    $StrSql="SELECT * FROM porcentajesRetenciones ";                                             
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      echo  
                      "<tr>
                        <td><center>".$registro['IdPorcentaje']."</center></td>  
                    ...
                    if($contador==0)
                    {
                        echo "<h2>No existen Porcentajes Retenciones</h2>";   
                    }?>
                </tbody>               
            </table>
              </div>
