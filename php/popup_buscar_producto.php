			...
			<table   border="1" cellspacing="0" cellpadding="0">
	          <style>
				...
				<tr  style='color: #0040FF;background-color:#FFFF00;'>
				    ...
				    <td width="10%" style='padding: 5px;'><center>  <b> Precio </b></center></td>
				    <td width="20%" style='padding: 5px;'><center>  <b> CargaIva </b></center></td>
				</tr>
				<?php
					if(isset($_GET['q']))
					{ 
							...
							while ($reg=mysqli_fetch_array($r_query) )
					        {
					           // $i++;
					            ...
					            echo "<tr OnMouseOver='Resaltar_On(this);' 
					                      ...
					                      <td style='color: #0040FF'> &nbsp $v_Precio 	&nbsp </td>
					                      <td style='color: #0040FF'> &nbsp $v_CargaIva 	    &nbsp </td>
					                   </tr>";
					      	}
					    }
					  }  
