<?php
    ...
    else
    {
       ...
       $v_IdPeriodoLectivo=$_REQUEST['IdPeriodoLectivo'];
       $Sql="Select * from periodoslectivo  where IdPeriodoLectivo=".$v_IdPeriodoLectivo;
       $rs  =   mysqli_query($conexion,$Sql);
       $reg =   mysqli_fetch_assoc($rs);

       $v_AnioInicial=$reg['AnioInicial'];
       $v_AnioFinal  =$reg['AnioFinal'];
       $v_Estado =$reg['Estado'];
...
<section>
    ...
    <form id='formulario'  role='form' method='POST' enctype='multipart/form-data' action='ActualizarPeriodoLectivo.php'>
       <section   style="color:#0080FF; background-color: #FFBF00; font-family:Verdana ;" />
            <h2 align=left>&nbspMODIFICAR PERIODO LECTIVO
         ...
         <div class="form-row">
            <div class="form-group col-md-12">
             ...
             value = '<?php echo $v_IdPeriodoLectivo;?>' ></center>
            </div>
         </div>
         <div class="form-row">
            <div class="form-group col-md-12">
             ...
             value = '<?php echo $v_AnioInicial;?>' ></center>
            </div>
         </div> 
         <div class="form-row">
            <div class="form-group col-md-12">
             ...
             value = '<?php echo $v_AnioFinal;?>' ></center>
            </div>
         </div> 
