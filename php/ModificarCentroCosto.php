<?php
    ...
    else
    {
       ...
       $sql="select * from admcentrocosto where IdCentroCosto= $x_IdCentroCosto";
       $rs        = mysqli_query($conexion,$sql);
       $reg       = mysqli_fetch_assoc($rs);
       $Codificacion    = $reg['CodificacionCentroCosto'];
       $DescCentroCosto = $reg['DescripcionCentroCosto'];
       $xEstado = $reg['EstadoCentroCosto']; 
       ##### ---------- Estados -----------#############
       $ListaEstados='';
...
<body>
<section>
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data' action='ActualizarCentroCosto.php'>  
      <div class='container'>
        <div class='panel panel-default'>
            <?php echo"<div class='panel-heading' style='font-size: 20px;color:#0080FF;font-weight:bold;'>Modificar Centro Costo
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <input type='hidden' id='IdCentroCosto' name='IdCentroCosto' value='<?php echo $x_IdCentroCosto;  ?>'>
                    <label style='color:#0080FF' for="f_usuario">&nbsp&nbspCodificación:&nbsp&nbsp</label>
                    <input style='color:#0080FF' type="text" class="form-control" id="CodigoCentroCosto" name="CodigoCentroCosto" placeholder="Codigo" value='<?php echo $Codificacion;  ?>'onblur='return VerificarDatos()'>
                  </div>
                  <div class="form-group col-md-12">
                    <label style='color:#0080FF' for="descripcion">Descripción:</label>
                    <input style='color:#0080FF' type="text" name='DescripcionCentroCosto' class="form-control" id="" placeholder="Nombre Centro Costo" value='<?php echo $DescCentroCosto;  ?>'>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
