...
<html lang='es'>            
    ...
    <section style='color:#0080FF; background-color: #FFBF00'>
        <center><h2>CONSULTA DE ALUMNOS
           ...
           <?php          
           echo "<button class='btn btn-primary btn-lg' title='Nuevo' style='font-size:20px;color:#0080FF;background-color: #FFBF00;border:none' onclick='window.location=\"NuevoAlumno.php\"' type='reset' ><span class='glyphicon glyphicon-file'></span></button> ";?>
        </h2></center>
    </section >
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                ...
                <tbody class='scrollContent'>
                    <?php 
                        $contador=0;
                        $StrSql="SELECT * from alumnos ORDER BY Apellidos,Nombres ";
                        ...
                        while($registro=  mysqli_fetch_array($ResultSet))
                        {
                          ...
                          "<tr>
                            <td><center>".$registro['IdAlumno']."</center></td>                      
                            <td>".$registro['Apellidos']." ".$registro['Nombres']."</td>
                            <td>".$registro['Mail']."</td>
                            <td>".$registro['TelefonoMovil']."</td>
                            <td><center><a href=ModificarAlumnos.php?IdAlumno=".$registro['IdAlumno']."><img src='../img/usuarios.png'></a></center></td>
                      
                          </tr>";
                        }
                        if($contador==0)
                        {
                            echo "<h2>No existen alumnos</h2>";   
                        }
                        echo "</tbody>";
                        ?>
                </tbody>
