...
<body>
<section>
    <form id='formulario'  role='form' method='POST' enctype='multipart/form-data' action='GrabaNuevoCurso.php'>
       <section   style="color:#0080FF; background-color: #FFBF00; font-family:Verdana ;" />
            <h2 align=left>&nbspNUEVO CURSO
         ...
         <div class='form-row'>
            <div class="form-group col-md-12">
             <label style='color:#0080FF'for="f_niveles">Niveles:</label>     
              <select id='IdNivel' name='IdNivel' class='form-control input-sm' required' >
               <option value=''>Seleccionar</option>"
