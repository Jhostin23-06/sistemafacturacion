...
<body>
<section>
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data' action='GrabarEditorial.php'>  
      <div class='container'>
        <div class='panel panel-default'>
            <?php echo"<div class='panel-heading' style='font-size: 20px;color:#0080FF;font-weight:bold;'>Nuevo Editorial
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input style='color:#0080FF' type="text" class="form-control" id="nombreeditorial" name="nombreeditorial" placeholder="Nombre Editorial" onblur='return VerificarDatos()'>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
