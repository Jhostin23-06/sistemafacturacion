  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE ALMACENES
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoAlmacen.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    ...
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Descripción Almacen</center></b></th>
                ...
                <?php 
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      "<tr>
                        ...
                        <td>".$registro['DescripcionAlmacen']."</td>        
                        <td>".$descEstado."</td>";
                      echo "<td><center>";
                      if($PermisoModificar=='S'){
                        echo "<a href=ModificarAlmacen.php?IdAlmacen=".$registro['IdAlmacen']."><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=EliminarAlmacen.php?IdAlmacen=".$registro['IdAlmacen']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
                    ...
                    if($contador==0)
                    {
                        echo "<h2>No existen Almacenes</h2>";   
                    }?>
                </tbody>               
            </table>
              </div>
