...
///  ********   agrega filas
        ...
        "<td width='32%'>"+DescripcionProducto+"</td>"+
        "<td width='6%' ><input type='number' class='form-controlxs' id='Cantidad"+indiceFila+"' Name='Cantidad"+indiceFila+"' value='"+Cantidad+"' class='sinborde'  size='2' onKeyUp='CalculaTotalLinea("+indiceFila+")' onChange='CalculaTotalLinea("+indiceFila+")' onBlur='CalculaTotalLinea("+indiceFila+")'></td>"+
        "<td width='7%' ><input type='text' id='Precio"+indiceFila+"' Name='Precio"+indiceFila+"' value='"+Precio+"' class='sinborde' readOnly size='5' ></td>"+
        "<td width='7%' ><input type='text' id='TotalBruto"+indiceFila+"' Name='TotalBruto"+indiceFila+"' value='"+TotalBruto+    "' class='sinborde' readOnly size='5'></td>"+
        "<td width='7%' ><input type='text' id='Descuento"+indiceFila+"' Name='Descuento"+indiceFila+"' value='"+Descuento+    "' class='sinborde' readOnly size='5'></td>"+
        "<td width='7%' ><input type='text' id='Subtotal"+indiceFila+"' Name='Subtotal"+indiceFila+"' value='"+Subtotal+ "' class='sinborde' readOnly size='5'></td>"+
        ...
        "<td  width='4%' ><center><a href='#' class='eliminar' width='5%'><span style='color: #FF0040' class='glyphicon glyphicon-trash'></span></a></center></td></tr>";   
...
function CalculaTotalLinea(i)
{
  ...
  //Total    = SubTotal+Iva;
  document.getElementById(campo_total_bruto).value=Cantidad*Precio;
  document.getElementById(campo_descuento).value=ValorDescuento;
  document.getElementById(campo_subtotal).value=(Cantidad*Precio)-ValorDescuento;
  document.getElementById(campo_iva).value=Iva;
  document.getElementById(campo_total).value= SubTotal+Iva;
  recalculaTotal();
}
...
{  
    ...
    "<td width='8%' ><input type='number' class='form-controlxs' id='Cantidad"+indiceFila+"' Name='Cantidad"+indiceFila+"' value='"+Cantidad+"' class='sinborde'  step='0.01' onkeypress='return pulsar(event);' onkeyup='CalculaTotalLineaProveedor("+indiceFila+");' onblur='CalculaTotalLineaProveedor("+indiceFila+");' onchange='CalculaTotalLineaProveedor("+indiceFila+");'></td>"+
    "<td width='8%' ><input type='number' class='form-controlxs' id='Precio"    +indiceFila+"' Name='Precio"    +indiceFila+"' value='"+Precio+"' class='sinborde'  step='0.01' onkeypress='return pulsar(event);' onkeyup='CalculaTotalLineaProveedor("+indiceFila+");' onblur='CalculaTotalLineaProveedor("+indiceFila+");' onchange='CalculaTotalLineaProveedor("+indiceFila+");'></td>"+
    "<td width='6%' ><input type='text' id='TotalBruto"    +indiceFila+"' Name='TotalBruto"    +indiceFila+"' value='"+TotalBruto+    "' onkeypress='return pulsar(event);' class='sinborde' readOnly size='5'></td>"+
    "<td width='6%' ><input type='text' id='Descuento"    +indiceFila+"' Name='Descuento"    +indiceFila+"' value='"+Descuento+    "' onkeypress='return pulsar(event);' class='sinborde' readOnly size='5'></td>"+
    "<td width='6%' ><input type='text' id='Subtotal" +indiceFila+"' Name='Subtotal" +indiceFila+"' value='"+Subtotal+ "' class='sinborde' onkeypress='return pulsar(event);' readOnly size='5'></td>"+
    "<td width='6%' ><input type='text' id='Iva" +indiceFila+"' Name='Iva" +indiceFila+"' value='"+Iva+ "' class='sinborde' readOnly size='5' onkeypress='return pulsar(event);'></td>"+
    "<td width='6%' ><input type='text' id='TotalLinea" +indiceFila+"' Name='TotalLinea" +indiceFila+"' value='"+TotalLinea+ "' onkeypress='return pulsar(event);' class='sinborde' readOnly size='5'></td>"+
    "<td width='6%' ><input type='text' id='CostoUnitario"+indiceFila+"' Name='CostoUnitario"+indiceFila+"' value='"+CostoUnitario+ "' onkeypress='return pulsar(event);' class='sinborde' readOnly size='5'></td>"+
...
function CalculaTotalLineaProveedor(i)
{
  ...
  var ValorDescuento =TotalBruto*(Descuento/100);
  var SubTotal = TotalBruto-ValorDescuento;
  var costoUnitario = SubTotal/Cantidad;
  var Iva =0;
  if(ValorIva==0)
  {
    Iva=0;
  ...
  {
    Iva  =  Subtotal*(parseFloat(document.getElementById('ivaActual').value)/100);
  }
  var Total    = SubTotal+Iva;
  document.getElementById(campo_total_bruto).value=Cantidad*Precio;
  document.getElementById(campo_descuento).value=ValorDescuento;
  document.getElementById(campo_subtotal).value=SubTotal;
  document.getElementById(campo_iva).value=Iva;
  document.getElementById(campo_total).value= Total;
  document.getElementById(campo_costoUnitario).value = costoUnitario;
...
function valida_cedula(x_tabla, x_evento)
{
	mi_mensaje("");
	var cedula = document.getElementById('f_cedula').value;
	var xflag=1;
