  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data' action='GrabarRetencion.php'>  
      <div class='container'>
        <div class='panel panel-default'>
            <?php echo"<div class='panel-heading' style='font-size: 20px;color:#0080FF;font-weight:bold;'>Nueva Retencion
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">	
                    ...
                    <input style='color:#0080FF' type="date" class="form-control" id="fechaRetencion" name="fechaRetencion" placeholder="Fecha Asignación" required>
                  </div>                  
                </div>
      ...
      function ObtieneValorRetenido(){
        if(xhr.readyState==4){
          if(xhr.status==200){
            ...
            document.getElementById('valorRetenido').value= (valorIva*(valorPorcentaje/100)).toFixed(4);
