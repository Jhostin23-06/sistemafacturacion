<?php 
        ...
        $datosEmisor.="   <claveAcceso>0000000000000000000000000000000000000000000000000XXXXXXXX</claveAcceso>\r";
        ...
        while($regFacturasXML= mysqli_fetch_array($rsFacturasXML))
        {
           ...
           while($regDetalleXML  =   mysqli_fetch_array($rsDetalle))
           {
                  ...
                  $xTarifaImpuesto    = $xTarifaImpuesto;
           	    ...
           	    else
           	    {
                    ...
                    $strFacturasXML.="    <descuento>".number_format($regDetalleXML['descuento'],2)."</descuento>\r";
           ...
           $rutaArchivo = "../xml/01-01-00".$IdMov."_".$SecSRI.".XML";
