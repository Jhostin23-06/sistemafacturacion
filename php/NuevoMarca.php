...
<body onload='foco();'>
<section>
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data' action='GrabarMarca.php'>  
      <div class='container'>
        <div class='panel panel-default'>
            <?php echo"<div class='panel-heading' style='font-size: 20px;color:#0080FF;font-weight:bold;'>Nueva Marca
              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input style='color:#0080FF' type="text" class="form-control" id="nombremarca" name="nombremarca" placeholder="Nombre Marca" onblur='return VerificarDatos()' required="yes">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
