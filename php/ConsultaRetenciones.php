  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE RETENCIONES
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoRetencion.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Ret</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>No.Fact.--Proveedor</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Secuencial<br>SRI</center></b></th>                    
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>SubTotal</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Iva</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Total</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>%Ret.</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>$ Ret.</center></b></th>
            ...
            <tbody class='scrollContent'  >
                <?php 
                    $contador=0;
                    $StrSql="SELECT * FROM Retenciones ".
                            " inner join porcentajesRetenciones on porcentajesRetenciones.IdPorcentaje=Retenciones.IdPorcentaje ".
                            " inner join factprov on factprov.IdFacturaProveedor = Retenciones.IdFacturaProveedor".
                            " inner join proveedores on proveedores.IdProveedor = factprov.IdProveedor ";
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      echo  
                      "<tr>
                        <td><center>".$registro['IdRetencion']."</center></td>  
                        <td><center>".$registro['NumeroCompletoFactura']."--".$registro['DescripcionProveedor']."</center></td>  
                        <td><center>".$registro['SecSRI']."</center></td>  
                        <td><center>".$registro['SubTotal']."</center></td>  
                        <td><center>".$registro['Iva']."</center></td>  
                        <td><center>".$registro['Total']."</center></td>  
                        <td><center>".$registro['ValorPorcentaje']."%</center></td>  
                        <td><center>".$registro['ValorRetenido']."</center></td>  
                        <td><center>".$registro['FechaRetencion']."</center></td>  
                        <td><center>".$descEstado."<center></td>";
                      echo "<td><center>";
                      if($PermisoModificar=='S'){
                        //echo "<a href=ModificarImpuesto.php?IdPorcentaje=".$registro['IdPorcentaje']."><span class='".$IconoModificar."'></span></a>";
                        echo "<a href='#'><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=ModificarImpuesto.php?IdPorcentaje=".$registro['IdPorcentaje']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
                    ...
                    if($contador==0)
                    {
                        echo "<h2>No existen Retenciones</h2>";   
                    }?>
                </tbody>               
            </table>
              </div>
