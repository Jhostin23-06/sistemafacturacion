  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE TIPOS DE RETENCIONES DEL IVA
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\" NuevoTipoRetencionIva.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Porcentaje<br>Ret. Iva</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Porcentaje<br>Ret. Iva</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Código SRI <br>Formulario</center></b></th>                    
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Descripción <br>Anexo SRI</center></b></th>
            ...
            <tbody class='scrollContent'  >
                <?php 
                    $contador=0;
                    $StrSql="SELECT * FROM PorcentajesRetencionesIva ";                                             
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      echo  
                      "<tr>
                        <td><center>".$registro['IdPorcentajeRetencionIva']."</center></td>  
                        <td><center>".$registro['PorcentajeRetencionIva']." %</center></td>  
                        <td><center>".$registro['CodigoSRI']."</center></td>  
                        <td><center>".$registro['Descripcion']."</center></td>  
                        <td>".$descEstado."</td>";
                      echo "<td><center>";
                      if($PermisoModificar=='S'){
                        echo "<a href=ModificarTipoRetencionIva.php?IdPorcentaje=".$registro['IdPorcentajeRetencionIva']."><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=ModificarTipoRetencionIva.php?IdPorcentaje=".$registro['IdPorcentajeRetencionIva']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
                    ...
                    if($contador==0)
                    {
                        echo "<h2>No existen Tipos de Retenciones del IVA</h2>";   
                    }?>
                </tbody>               
            </table>
              </div>
