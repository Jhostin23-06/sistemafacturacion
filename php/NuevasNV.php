              ...
              <div class="panel-body" style="width:75%; float:left; display:block;padding: 0px;"> 
                  <div class="form-row" style="padding: 4px;margin: 0px;" >
                      ...
                      <div class="form-group col-md-2" style='padding: 4px;margin: 0px;'>
                          ...
                          <input style='color:#0080FF;padding: 4px;margin: 0px;' type="text" class="form-control" id="Cedula" name='Cedula' placeholder="Cédula o RUC" autocomplete="no" onkeypress="buscarCliente(event)" onkeydown="buscarClienteTab(event)">
                      </div>                      
           ...
           <div class="form-row"  style='width:100%;padding:2px;margin: 7px;margin-top: 0px;margin-right: 0px'>
                 <!--     <div class="form-group col-md-4" style='padding: 4px;margin: 0px;'>
                  ...
                  <div class="form-group col-md-1" style='padding:0px;margin: 7px;margin-top: 0px'>
                    ...
                    <input type='button' name='btnAgregar' id='add' class='btn btn-primary btn-sm' value='Add' onclick="addFilasFacturaIvaCero();" >
                  </div>
           </div>
...
function crearNuevoCliente()
{
   ...
   function capturaKey(event){
     ...
     if(tecla==113){
        addFilasFacturaIvaCero();
     }
   }

var i=0;
//#-----------------recalcula totales ------------------#
function recalculaTotalNotaVenta(){
            var xTotalBruto=0;
            var xTotalFactura=0;
            var xSubTotal=0;
            var xDescuento=0;
