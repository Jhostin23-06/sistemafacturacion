              ...
              <div class="panel-body" style="width:75%; float:left; display:block;"> 
                  <div class="form-row"  >
                      ...
                      <div class="form-group col-md-3">
                          ...
                          <input style='color:#0080FF' type="text" class="form-control" id="Cedula" name='Cedula' placeholder="Cédula o RUC" onkeypress="buscarCliente(event)">
                      </div>
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        <label style='color:#0080FF'  for="f_colegio">Empresa:</label>
                        <select style='color:#0080FF' id='IdColegio' name='IdColegio' class="form-control" onchange='getPorceDescuento()' required="yes">
...
function buscarCliente(e) { 
  ...
  if(tecla==13)
  {
     if(longcedula>=10)
     {
          ...
          xhr.open('POST','retornaDatosCliente.php',false);
          xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
